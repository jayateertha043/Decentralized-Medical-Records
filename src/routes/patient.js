...
class Patient extends Component {
    ...
    onRecordSubmit= async()=>{
        ...
        console.log(url);
        let result = await this.DMR.methods.addRecord(this.state.account,this.state.hname,this.state.reason,this.state.admOn,this.state.disOn,this.state.ipfs).send({from:this.state.account});
        console.log(result);
